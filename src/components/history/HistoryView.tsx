...
function EntryRow({
  ...
  return (
    <div
      className="flex items-start gap-3 py-3 border-b border-sand-100 last:border-b-0 group"
    ...
    >
      ...
      <div className="shrink-0 flex items-center gap-1 mt-1">
        {/* Own entries: show delete on hover */}
        {isOwnEntry && hovering && (
          <Button
            variant="ghost"
            size="sm"
            className="text-sand-400 hover:text-sand-600 !px-2"
        ...
        {/* Other parent's entries: show flag button if no dispute yet */}
  ...
  return (
    <div className="pb-2">
      ...
      <div className="pt-4 pb-3">
        <h1 className="text-xl font-bold text-bark">History</h1>
      </div>
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-sand-400 text-center py-12">
          No entries yet.
        </p>
      ) : (
        <Card className="px-4">
